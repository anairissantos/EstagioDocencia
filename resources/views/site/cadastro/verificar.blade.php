            ...
            <div class="row">
                <div class="container">
                    <div class="container">
                        ...
                        <input  required style="margin-bottom: 40px"  type="" maxlength="90" size="90" align="center" name="Nome" class="form-controll" value="{{$aluno->Nome}}">
                    </div>
                    <div class="container">
                    ...
                    <div class="container">
                        ...
                        <label style="margin-bottom: 40px"  class="control-label">Semestre:</label>
                            <input  required style="margin-bottom: 40px"  maxlength="5" size="5" align="center" name="Semestre" class="form-controll" value="{{$cadastro->Semestre}}" >
                        @endforeach
                    </div>
                </div>
